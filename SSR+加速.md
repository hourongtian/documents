...
**本人愚钝，在学习了github大佬Alvin9999的文章后才懂得自建vps搭建ssr科学上网，本文既是转载Alvin9999的文章，仅作记录方便查阅，附上大佬的github地址**
...
[vultr注册地址](https://www.vultr.com/?ref=7777564-4F)（vultr在2019年1月的最新活动，针对新用户，直接送50美元！全球15个服务器位置可选，kvm框架。如果以后这个vultr注册地址被墙了，那么就用翻墙软件打开，或者用ss/ssr免费账号）
...
![ssr](https://fdlucifer.github.io/images/ssr1.jpg)

### 开通服务器步骤如图：

![ssr](https://fdlucifer.github.io/images/ssr2.jpg)
...
购买服务器后，需要部署一下。因为你买的是虚拟东西，而且又远在国外，我们需要一个叫juiceSSH的手机软件来远程部署。

部署方法我就不多说了，直接填上账号密码后连接即可。

连接成功后开始复制粘贴以下代码，开始自动部署
...
输入数字1来安装SSR服务端。如果输入1后不能进入下一步，那么请退出xshell，重新连接vps服务器，然后输入快捷管理命令bash ssr.sh 再尝试。
...
提示你是否选择兼容原版，这里的原版指的是SS客户端（SS客户端没有协议和混淆的选项），可以根据需求进行选择，演示选择y
...
![ssr](https://fdlucifer.github.io/images/ssr6.jpg)
...
![ssr](https://fdlucifer.github.io/images/ssr7.jpg)

提示没有完全匹配的内核,随便选一个内核就行,按照提示来输入数字,按回车键即可

锐速安装成功标志如下：

![ssr](https://fdlucifer.github.io/images/ssr8.jpg)
...
![ssr](https://fdlucifer.github.io/images/ssr9.jpg)
...
10、路由器也可以配置ss/ssr账号，详见[openwrt-ssr项目地址](https://github.com/ywb94/openwrt-ssr)
